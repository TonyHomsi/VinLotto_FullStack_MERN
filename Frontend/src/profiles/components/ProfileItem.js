...
const ProfileItem = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <p>
          Do you want to proceed and delete your amazing profile? Please note
          that it can't be undone thereafter so be wise.
        </p>
      </Modal>
        ...
        <Card className="profile-item__content">
          ...
          <div className="profile-item__actions">
            {auth.userId === props.creatorId && (
              <Button to={`/profiles/${props.id}`}>EDIT</Button>
            )}
            {auth.userId === props.creatorId && (
